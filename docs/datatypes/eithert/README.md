...
eitherTVal
//EitherT(value=ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@31067347))
```
...
```kotlin
eitherTVal.value()
//ObservableKW(observable=io.reactivex.internal.operators.observable.ObservableJust@31067347)
```
